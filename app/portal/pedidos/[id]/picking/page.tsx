...
export default async function PickingListCliente({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="no-print mb-4 p-3 rounded text-sm" style={{ border: '2px solid #676F36', color: '#676F36', background: '#FBF9F3' }}>
        ¡Tu pedido quedó registrado! Imprime o guarda esta lista para verificar tus productos al
